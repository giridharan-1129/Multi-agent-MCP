...
class IndexRepositoryTool(MCPTool):
    ...
    description = "Index a GitHub repository into the knowledge graph"
    category = "indexing"
...
class GetIndexStatusTool(MCPTool):
    ...
    description = "Get statistics about the indexed knowledge graph"
    category = "indexing"
...
class ClearIndexTool(MCPTool):
    ...
    name = "clear_index"
    description = "Clear all data from the knowledge graph (WARNING: destructive)"
    category = "indexing"
...
class IndexerAgent(BaseAgent):
    ...
    name = "indexer"
    description = "Indexes GitHub repositories into the knowledge graph"
    version = "1.0.0"
